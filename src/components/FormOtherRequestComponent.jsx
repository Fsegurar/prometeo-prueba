...
//myHeaders.append("Cookie", "JSESSIONID=B688F870E71541551EA587B7101641CC");

const formdata = new FormData();
formdata.append("request", "{\n\"userEntity\": \"nosegura\",\n\"requestTypeEntity\": \"Otras solicitudes\",\n \"programStudent\": \"Ingeniería de Sistemas\", \n\"description\":\"otra\"\n}");
...
const requestOptions = {
  ...
  redirect: "follow"
    ...
    try {
      fetch("https://prometeo-backend-e8g5d5gydzgqezd3.eastus-01.azurewebsites.net/api/request/uploadAndCreateRequest", requestOptions)
